package se.docksidelabs.airhockeyserver.canvas;
...
import se.docksidelabs.airhockeyserver.game.properties.Vector;
...
public class CanvasTest extends Application {
    ...
    private static Circle createCircle(se.docksidelabs.airhockeyserver.game.objects.Circle circle) {
        return createCircle(circle, Color.BLACK);
    }

    private static Circle createCircle(se.docksidelabs.airhockeyserver.game.objects.Circle circle, Color color) {
